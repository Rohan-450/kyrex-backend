...
export const buildOptions = ({ cliOptions }) => {
    ...
    if (["list", "codegen"].includes(cliOptions.command))
        logLevel = "error";
    ...
    return {
        ...
        indexingCacheMaxBytes: 2 **
            Math.min(Math.max(Math.round(Math.log2(v8.getHeapStatistics().heap_size_limit / 1024 / 1024 / 8)), 7), 11) *
            1024 *
            1024,
