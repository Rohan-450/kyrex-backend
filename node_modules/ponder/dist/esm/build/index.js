    ...
    const build = {
        ...
        async executeApi({ indexingBuild, database }) {
            ...
            if (!fs.existsSync(common.options.apiFile)) {
                const error = new BuildError(`API function file not found. Create a file at ${common.options.apiFile}. Read more: https://ponder-docs-git-v09-ponder-sh.vercel.app/docs/query/api-functions`);
            ...
            if (app?.constructor?.name !== "Hono") {
                const error = new BuildError("API function file does not export a Hono instance as the default export. Read more: https://ponder-docs-git-v09-ponder-sh.vercel.app/docs/query/api-functions");
                error.stack = undefined;
                common.logger.error({
                    service: "build",
                    msg: "Failed build",
